...
class TernDocumentTest(unittest.TestCase):
    ...
    def test_create_from_sents(self):
        ...
        self.assertEqual(str(s), xml.dom.minidom.parseString('<DOC><DOCNO>ABC123</DOCNO><BODY><TEXT>This is some annotated text. This is a second sentence.</TEXT></BODY></DOC>').toxml())
    
    def test_create_from_sents_with_dct(self):
        s = TernDocument.create([[('This', 'POS', set()), ('is', 'POS', set()), ('some', 'POS', set()), ('annotated', 'POS', set()), ('text.', 'POS', set())],
                                        [('This', 'POS', set()), ('is', 'POS', set()), ('a', 'POS', set()), ('second', 'POS', set()), ('sentence.', 'POS', set())]], 'ABC123',
                                        dct='20100802')
        self.assertEqual(str(s), xml.dom.minidom.parseString('<DOC><DOCNO>ABC123</DOCNO><DATE_TIME>08/02/2010</DATE_TIME><BODY><TEXT>This is some annotated text. This is a second sentence.</TEXT></BODY></DOC>').toxml())
    ...
    def test_reconcile_DCT_sents_DATE_TIME(self):
        ...
        s[0][0][2].add(t)
        d.reconcile_dct(s)
        self.assertEqual(str(d), xml.dom.minidom.parseString('<DOC><DOCNO>ABC123</DOCNO><DATE_TIME><TIMEX2 VAL="ABCDEF">20100801</TIMEX2></DATE_TIME><BODY><TEXT>This is some annotated text. This is a second sentence.</TEXT></BODY></DOC>').toxml())
    ...
    def test_reconcile_DCT_sents_DATE(self):
        ...
        s[0][0][2].add(t)
        d.reconcile_dct(s)
        self.assertEqual(str(d), xml.dom.minidom.parseString('<DOC><DOCNO>ABC123</DOCNO><DATE><TIMEX2 VAL="ABCDEF">20100801</TIMEX2></DATE><BODY><TEXT>This is some annotated text. This is a second sentence.</TEXT></BODY></DOC>').toxml())